#' Doubly-robust estimator for unit quality standardized to an equity-weighted population, using plug-in influence-function-based estimation and sample splitting, as in double machine learning.
#'
